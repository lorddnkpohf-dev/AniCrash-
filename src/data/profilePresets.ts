...
export const AURA_PRESETS: AuraPreset[] = [
  ...
  },
  {
    id: 'berserk-sword',
    name: 'Меч Берсерка',
    className: 'border-slate-400 shadow-[0_0_24px_rgba(148,163,184,0.9)] ring-2 ring-slate-400/50',
    glowColor: '#94a3b8',
    description: 'Массивный клинок, ставший символом борьбы против судьбы.',
    episodesRequired: 50,
  },
];
